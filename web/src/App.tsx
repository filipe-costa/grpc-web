...
import { Todo } from "./codegen/todos_pb";
...
function App() {
  ...
  const editTodo = ({ uuid, done, description }: Todo.AsObject) => {
    ...
    if (index >= 0) {
      ...
      setTodos(newTodos);
      service
        .editTodo({ uuid, done, description })
        .then(() => {
    ...
    <>
      ...
      <Container className={classes.container}>
        <Grid container justify="center">
          ...
          {isLoading && !error && <CircularProgress disableShrink />}
