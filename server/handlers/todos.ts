...
class TodosServer implements ITodosServer {
    getTodos(_: grpc.ServerUnaryCall<GetTodosRequest, GetTodosResponse>, callback: grpc.sendUnaryData<GetTodosResponse>) {
    ...
    createTodo(call: grpc.ServerUnaryCall<CreateTodoRequest, Todo>, callback: grpc.sendUnaryData<Todo>) {
    ...
    editTodo(call: grpc.ServerUnaryCall<EditTodoRequest, Todo>, callback: grpc.sendUnaryData<Todo>) {
        const {description, done, uuid} = call.request.toObject()
        const req = new Todo()
        TodoModel.update({description, done}, {
            where: {
                uuid
            }
        })
    ...
    deleteTodo(call: grpc.ServerUnaryCall<DeleteTodoRequest, DeleteTodoResponse>, callback: grpc.sendUnaryData<DeleteTodoResponse>) {
